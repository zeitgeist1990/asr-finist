...
1. Вы также можете запустить оффлайн-распознавание напрямую в Python:
   ```python
   ...
   print(pipeline.forward_offline(audio))  # оффлайн-распознавание
   ```
...
Для более подробного изучения архитектуры, деталей реализации и принятых решений — читайте нашу статью (ссылка на публикацию будет добавлена позже).
...
| Категория | T-one (70M) | GigaAM-RNNT v2 (243M) | GigaAM-CTC v2 (242M) | Vosk-model-ru 0.54 (65M) | Vosk-model-small-streaming-ru 0.54 (20M) | Whisper large-v3 (1540M) |
|:--|:--|:--|:--|--:|:--|:--|
